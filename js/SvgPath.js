    ...
    class SvgPath {
        ...
        move(x,y) {
            ...
            if (this._pathWillChange(x, y)) {
                if (this._lastAction == ACTION.MOVE) // remove last move from string
        ...
        horizontal(x) {
            ...
            if (this._pathWillChange(x, this._y)) {
                if (this._lastAction == ACTION.HORIZONTAL) // remove last move from string
        ...
        vertical(y) {
            ...
            if (this._pathWillChange(this._x, y)) {
                if (this._lastAction == ACTION.VERTICAL) // remove last move from string
